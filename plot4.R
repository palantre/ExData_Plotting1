...
# Creating plot (Plot 4)
par(mfrow = c(2, 2))
plot(datetime, hpc2$global_active_power, type="l", xlab="", ylab="Global Active Power")
plot(datetime, hpc2$voltage, type="l", xlab="datetime", ylab="Voltage")
...
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty=1, lwd=2.5, box.lty = 0, col=c("black", "red", "blue"), cex=0.7)
plot(datetime, hpc2$global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
